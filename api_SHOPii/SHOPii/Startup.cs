...
namespace SHOPii
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Config SQL Database
            services.AddDbContext<SHOPIIContext>(options =>
             options.UseSqlServer(new ConfigurationBuilder().AddJsonFile("appsettings.json").Build().GetSection("Database")["ConnectionString"]));
